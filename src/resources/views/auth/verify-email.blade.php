        ...
        <section class="error">
            ...
            <div class="error__content">
                <div class="error__message message">
                    <h1 class="message__title text-white">{{__($noticeTitle)}}</h1>
                    <p class="message__text text-white">{!!__($message)!!}</p>
                </div>
                <div class="error__nav e-nav">
                    <a href="{{$link}}" class="btn btn-info text-white">{{__($control)}}</a>
                    <a href="/" target="_blank" class="btn btn-info text-white">{{__("Back Home")}}</a>
                </div>
            </div>
            <!-- END Content -->
