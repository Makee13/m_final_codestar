...
@section('middle')
    <!-- Content page -->
    <section class="bg0 p-t-75 p-b-120 m-t-150">
        <div class="container">
            <div class="row p-b-148">
                <div class="col-md-7 col-lg-8">
                    <div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
                        <h3 class="mtext-111 cl2 p-b-16 text-dark">
                            {{__('Our Story')}}
                        </h3>

                        <p class="stext-113 cl6 p-b-26">
                            {{__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris consequat consequat enim, non
                        ...
                        <p class="stext-113 cl6 p-b-26">
                            {{__('Donec gravida lorem elit, quis condimentum ex semper sit amet. Fusce eget ligula magna. Aliquam
                        ...
                        <p class="stext-113 cl6 p-b-26">
                            {{__('Any questions? Let us know in store at 8th floor, 379 Hudson St, New York, NY 10018 or call us
                            on (+1) 96 716 6879')}}
                        </p>
                    </div>
                </div>
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="/template/images/about-1.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="order-md-2 col-md-7 col-lg-8 p-b-30">
                    <div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
                        ...
                        <p class="stext-113 cl6 p-b-26">
                            {{__('Mauris non lacinia magna. Sed nec lobortis dolor. Vestibulum rhoncus dignissim risus, sed
                        ...
                        <div class="bor16 p-l-29 p-b-9 m-t-22">
                            <p class="stext-114 cl6 p-r-40 p-b-11">
                                {{__("Creativity is just connecting things. When you ask creative people how they did something,
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="/template/images/about-2.webp" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
