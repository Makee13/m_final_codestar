    ...
    <div class="container">
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                {{ __('All rights reserved | This template is made with') }} <i
                    class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com"
                    target="_blank">{{ __('Colorlib') }}</a>.
                {{ __('Downloaded from') }} <a href="https://themeslab.org/" target="_blank">{{ __('Themeslab') }}</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
