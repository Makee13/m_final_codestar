                    ...
                    <div class="m-l-25 m-r--38 m-lr-0-xl">
                        <div class="wrap-container-infor">
                            <div class="container-infor bor10 p-t-18 p-b-15 p-lr-40 p-lr-15-sm" style="min-width: unset;">
                                <h2 class="mtext-109 cl2 p-b-10 text-center text-dark">{{__('Create password level 2')}}</h2>
                                <p class="text-lightgray fs-13 m-b-20 text-center"><em>{{__('Password level 2 help you to reset password when forgot this')}}</em></p>
                                @if(session('success'))
                                ...
                                <div class="form-main">
                                    <div class="form-group">
                                        <label for="password">{{__('Password level 2')}}</label>
                                            <input id="password" name="password" class="bor10 p-2" style="width: 100%;" type="password" class="password" placeholder="Enter your password" @if($errors->any()) value="{{old('password')}}" @endif>
                                        <x-display-error name-input="password" />
                                    </div>
                                    <div class="form-group">
                                        <label for="confirm-password">{{__('Confirm password level 2')}}</label>
